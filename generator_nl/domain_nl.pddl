...
(:process generate_power
    :parameters (?g - generator)
    :precondition (and (online ?g) (> (fuelLevel ?g) 0.0)(< (generator_running ?g) (generator_duration)))
...
(:process refuel_generator
    :parameters (?g - generator ?t -tank)
    :precondition (and (using ?t) (< (refuel_running ?g ?t) (refuel_duration)))
    :effect (and
                    (increase (fuelLevel ?g) (* #t (* 0.1 (^ (refuel_running ?g ?t) 2))))
