...
(define 
    (problem instance1)
    (:domain hvac)
    (:objects r1  -room k1 k2 k3 k4 k5 k6 k7 k8 k9 -request)
    (:init
    ...
    (:goal 
        (and  (satisfied k1)(satisfied k2)(satisfied k3)(satisfied k4)(satisfied k5)(satisfied k6) (satisfied k7) (satisfied k8)(satisfied k9))
    )
)
