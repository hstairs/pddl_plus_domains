qq(define
	...
	(cost_moving_obstacle) ;; the immediate cost of the HAPS stepping into a moving obstacle
...
;;    ;; increase cost if HAPS make a turn
;;    (:process increase_cost_while_turning
;;	:parameters ()
;;	:precondition (and
;;				(> (abs heading_rate) 0.0)
;;	)
;;	:effect (and
;;			(increase (total-cost) (/ (abs heading_rate) 0.018))
;;	)
;;   )
