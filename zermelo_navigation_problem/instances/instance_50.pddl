(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (-2.6,0.37) about 5.1 knots, direction 172.0 degrees
        (= (wind_x r0) -2.6)
        (= (wind_y r0) 0.37)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (3.1,1.4) about 6.6 knots, direction 24.0 degrees
        (= (wind_x r1) 3.1)
        (= (wind_y r1) 1.4)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (1.6,0.5) about 3.3 knots, direction 17.0 degrees
        (= (wind_x r2) 1.6)
        (= (wind_y r2) 0.5)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (-1.9,0.48) about 3.8 knots, direction 166.0 degrees
        (= (wind_x r3) -1.9)
        (= (wind_y r3) 0.48)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
