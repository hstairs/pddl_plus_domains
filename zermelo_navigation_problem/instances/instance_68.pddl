(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (-2.2,1.5) about 5.2 knots, direction 146.0 degrees
        (= (wind_x r0) -2.2)
        (= (wind_y r0) 1.5)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (2.7,1.1) about 5.6 knots, direction 22.0 degrees
        (= (wind_x r1) 2.7)
        (= (wind_y r1) 1.1)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (-0.099,-2.8) about 5.5 knots, direction 268.0 degrees
        (= (wind_x r2) -0.099)
        (= (wind_y r2) -2.8)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (0.65,-1.7) about 3.5 knots, direction 291.0 degrees
        (= (wind_x r3) 0.65)
        (= (wind_y r3) -1.7)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
