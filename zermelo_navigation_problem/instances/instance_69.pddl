(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (-2.5,-2.7) about 7.1 knots, direction 227.0 degrees
        (= (wind_x r0) -2.5)
        (= (wind_y r0) -2.7)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (2.4,-0.3) about 4.8 knots, direction 353.0 degrees
        (= (wind_x r1) 2.4)
        (= (wind_y r1) -0.3)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (1.1,1.7) about 3.9 knots, direction 57.0 degrees
        (= (wind_x r2) 1.1)
        (= (wind_y r2) 1.7)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (-3.4,0.36) about 6.6 knots, direction 174.0 degrees
        (= (wind_x r3) -3.4)
        (= (wind_y r3) 0.36)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
