(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (-0.6,-2.8) about 5.6 knots, direction 258.0 degrees
        (= (wind_x r0) -0.6)
        (= (wind_y r0) -2.8)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (0.81,-1.9) about 4.1 knots, direction 293.0 degrees
        (= (wind_x r1) 0.81)
        (= (wind_y r1) -1.9)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (-1.9,-2.0) about 5.4 knots, direction 226.0 degrees
        (= (wind_x r2) -1.9)
        (= (wind_y r2) -2.0)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (1.6,2.0) about 5.0 knots, direction 52.0 degrees
        (= (wind_x r3) 1.6)
        (= (wind_y r3) 2.0)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
