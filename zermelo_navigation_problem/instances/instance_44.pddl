(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (-3.1,-0.6) about 6.2 knots, direction 191.0 degrees
        (= (wind_x r0) -3.1)
        (= (wind_y r0) -0.6)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (0.81,-1.8) about 3.9 knots, direction 294.0 degrees
        (= (wind_x r1) 0.81)
        (= (wind_y r1) -1.8)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (1.5,-3.4) about 7.3 knots, direction 294.0 degrees
        (= (wind_x r2) 1.5)
        (= (wind_y r2) -3.4)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (3.3,0.11) about 6.3 knots, direction 2.0 degrees
        (= (wind_x r3) 3.3)
        (= (wind_y r3) 0.11)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
