(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (1.3,0.37) about 2.6 knots, direction 16.0 degrees
        (= (wind_x r0) 1.3)
        (= (wind_y r0) 0.37)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (0.71,1.5) about 3.3 knots, direction 65.0 degrees
        (= (wind_x r1) 0.71)
        (= (wind_y r1) 1.5)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (3.0,-2.4) about 7.4 knots, direction 322.0 degrees
        (= (wind_x r2) 3.0)
        (= (wind_y r2) -2.4)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (-0.52,-1.2) about 2.6 knots, direction 247.0 degrees
        (= (wind_x r3) -0.52)
        (= (wind_y r3) -1.2)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
