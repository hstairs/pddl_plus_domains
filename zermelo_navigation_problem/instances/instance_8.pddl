(define
    ...
    (:init
        ...
        ;; Region properties
        ;; Region 0, wind velocity is (0.15,1.4) about 2.7 knots, direction 84.0 degrees
        (= (wind_x r0) 0.15)
        (= (wind_y r0) 1.4)
        (= (min_x r0) 0.0)
        (= (min_y r0) 5000.0)
        ...
        ;; Region 1, wind velocity is (0.55,-1.8) about 3.6 knots, direction 287.0 degrees
        (= (wind_x r1) 0.55)
        (= (wind_y r1) -1.8)
        (= (min_x r1) 5000.0)
        (= (min_y r1) 5000.0)
        ...
        ;; Region 2, wind velocity is (1.8,-0.33) about 3.6 knots, direction 350.0 degrees
        (= (wind_x r2) 1.8)
        (= (wind_y r2) -0.33)
        (= (min_x r2) 0.0)
        (= (min_y r2) 0.0)
        ...
        ;; Region 3, wind velocity is (2.5,-1.6) about 5.9 knots, direction 327.0 degrees
        (= (wind_x r3) 2.5)
        (= (wind_y r3) -1.6)
        (= (min_x r3) 5000.0)
        (= (min_y r3) 0.0)
